...
namespace SpotLights.Shared.Constants;

public static class SpotLightsConstant
{
  public const string Key = "SpotLights";
  ...
  public const string PolicyCorsName = "SpotLightsPolicy";
  ...
  public static string ConfigSectionKey = "SpotLights";
